...
extension ReminderViewController {
    ...
    func headerConfiguratoin(for cell: UICollectionViewListCell,
    ...
    func dateConfiguration(for cell: UICollectionViewListCell,
                           with date: Date) -> DatePickerContentView.Configuration {
    ...
    func notesConfiguration(for cell: UICollectionViewListCell,
                            with notes: String?) -> TextViewContentView.Configuration {
